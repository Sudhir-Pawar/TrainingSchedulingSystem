...
public class TrainingProgramBean {
	...
	private TrainingProgramBean(String execution_Month){
		this.execution_Month=execution_Month;
	}
	private TrainingProgramBean(int training_Program_code){
		this.training_Program_code=training_Program_code;
	}
	...
	public static TrainingProgramBean createTrainingProgramObjectForMonth(String execution_Month){
		return new TrainingProgramBean(execution_Month);
	}
	public static TrainingProgramBean createTrainingProgramObjectForCode(int training_Program_code){
		return new TrainingProgramBean(training_Program_code);
	}	
}
